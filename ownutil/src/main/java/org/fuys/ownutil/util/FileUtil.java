...
public class FileUtil {
	...
	public static void main(String[] args) throws Exception {
		System.out.println(FileUtil.length("C:\\Users\\ys\\Desktop\\Linux常用指令.txt", 2, FileUtil.KILOBYTE));
		System.out.println("************************************************************");
		File file = new File("C:\\Users\\ys\\Desktop\\Linux常用指令.txt");
		...
		while (flag2 == false) {
			...
			if (str.matches("[0-9]+")) {
				System.out.println("输入数字内容：" + str);
				flag2 = true;
			} else {
				System.out.println("内容错误，请重新输入数字");
			}
		}
		br.close();
